...
export function Footer() {
  return (
    <footer className="bg-[#24262D] px-4 mt-12 md:px-10 text-muted-foreground">
      <div className="container grid grid-cols-1 gap-12 py-12 lg:grid-cols-6">
        {/* Logo & description */}
        <div className="md:col-span-2">
          <div className="md:flex hidden items-center space-x-2">
            <Image src="/plain-logo.png" alt="DigiPlus Logo" width={100} height={40} />
          </div>
           <div className="flex items-center space-x-2 md:hidden">
            <Image src="/mobile-logo.png" alt="DigiPlus Logo" width={100} height={40} />
          </div>
          <p className="mt-4 max-w-md text-sm md:text-base text-white leading-relaxed">
            Digiplus Alliance DIH is a consortium led and operated by 8thGear Partners Ltd.
          </p>
        </div>
        ...
        <div>
          ...
          <ul className="space-y-4 text-sm">
            ...
            <li><Link href="/terms" className="hover:underline">Our Terms & Conditions</Link></li>
            <li><Link href="/privacy" className="hover:underline">Privacy Policies</Link></li>
          </ul>
        </div>
        ...
        <div>
          ...
          <ul className="space-y-4 text-sm">
            ...
            <li>Market and Policy Insight</li>
            <li>Research Commercialisation</li>
            <li>Test Before Invest</li>
          </ul>
        </div>
        ...
        <div>
          ...
          <ul className="space-y-4 text-sm">
            ...
            <li><a href="tel:+2349132462410" className="hover:underline">+234 913 246 2410</a></li>
            <li><a href="mailto:info@digiplus.africa" className="hover:underline">info@digiplus.africa</a></li>
            <li><a href="https://www.digiplus.africa/" className="hover:underline">www.digiplus.africa</a></li>
          </ul>
        </div>
      </div>
      ...
      <div className="border-t border-gray-700 py-6 lg:text-left text-center text-xs text-[#B8B8B8]">
        © DigiPlus. Providing digital solutions across the Globe. All rights reserved.
      </div>
    </footer>
  );
}
